...
// ya que al ser este método abstracto en la clase padre, les forzamos las clases hijas a que
// implementen ese método.
        for (Viaje viaje : viajes) {
            ...
            System.out.println("Costo mas IVA: " + viaje.obtenerCostoConIva());
            System.out.println("Cantidad de dias: " + viaje.cantidadDias());
            System.out.println("");
        }
    }
}
