...
public class Main {
    public static void main(String[] args) {
        ...
        director.create("Wok for family", "https://www.hola.com/imagenes/cocina/noticiaslibros/20200206159868/recetas-con-wok/0-778-991/portada-wok-age-m.jpg");
        ...
        director.create("Spaghetti Amatriciana","https://okdiario.com/img/recetas/2017/04/04/espaguetis-amatriciana-00.jpg");
